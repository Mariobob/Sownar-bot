...
class Utils():
    ...
    async def help(ctx):
      ...
      #embed.add_field(name="__Utility commands!__", value="", inline=False)
      #embed.add_field(name="s.servers", value="Show the number of servers and members the bot is serving", inline=False)
      #embed.add_field(name="s.serverinfo", value="Shoes information on the server", inline=False)
      #embed.add_field(name="s.ticket", value="Sends a ticket to the dev team", inline=False)
      #embed.add_field(name="s.suggest", value="Sends a suggestion to the dev team", inline=False)          
      #embed.add_field(name="s.about", value="Shows info on the bot", inline=False)
      #embed.add_field(name="s.stats", value="Shows the bot's stats", inline=False)
      #embed.add_field(name="s.ping", value="Shows the bot's latency", inline=False)
      ...
      #embed.add_field(name="__Moderator commands!__", value="", inline=False)
