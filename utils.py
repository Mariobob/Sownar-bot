...
class Utils():
    ...
    async def permissions(ctx, member: discord.Member=None):
      ...
      em.add_field(name="Is Owner",value=(ctx.message.server.owner == user))
      ...
      emb.add_field(name="Can Connect to Voice Channels",value=up.connect)
      emb.add_field(name="Can Speak in Voice Channels",value=up.speak)
