   ...
   #       else:
    #        voicechanneles += 1
     #   print(textchannels)
        ...
        embed.add_field(name="Member Count", value="- {0} members" \ "- {1} bots" \ "- {2} / {3} online".format(humanusers, botusers, online, totalusers), inline=False)
        embed.add_field(name="Channels", value="- Default channel: {0}" \ "- Total channels: {1}" \ "- AFK: {2} after {3}min".format(server.default_channel, totalchannels, server.afk_channel, server.afk_timeout), inline=False)
